<template>
    <div>
        ...
        <el-dialog title="修改转借信息" :visible.sync="dialogFormVisible">
            <el-form :model="formData">
                ...
                <el-form-item label="序列号" :label-width="formLabelWidth">
                    <el-select v-model="deviceUid" placeholder="请选择">
                        <el-option
                            v-for="r in $store.state.deviceStore.deviceList"
                            :key="r.did"
                            :label="r.duid"
                            v-show="r.dname === deviceName"
                            :value="r.duid">
                        </el-option>
                    </el-select>
                </el-form-item>
...
export default {
    ...
    mounted(){
        console.log(this.$store.state.deviceStore.deviceList);
        this.initData();
        this.$nextTick(()=>{
